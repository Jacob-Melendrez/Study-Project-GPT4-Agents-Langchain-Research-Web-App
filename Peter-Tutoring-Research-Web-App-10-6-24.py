import streamlit as st
    ...
    #This uses the import statement with an alias as for the module streamlit for ease of use later in the program. 

from dotenv import load_dotenv
# Allows you to import function from dotenv library (specifically .env file) for managing sensitive information securely. 
# (These include Application Programming Interface Keys)
# Uses a from - import statement to import a specific component from the library dotenv. 
...
from langchain.llms import OpenAI
    ...
    # to a single file.)
    # Uses a from - import statement to import a specific component from the library langchain.llms. 
    # The dot between langchain and llms represents hierarchy in the module. llms is a submodule that is being referenced. 
...
# If the submit message button is clicked then the following code block runs. 
            memory = ConversationBufferMemory(memory_key="chat_history")
...
# The ConversationBufferMemory is class that is being used to be assigned to the variable memory. 
